...
/**
 * dijkstra - Calcul le plus court chemin dans un graphe, entre les noeuds
 * donnés. La fonction retourne la distance calculée, et peuple le chemin passé
 * en paramètre (si non NULL) avec le chemin correspondant.
 *
 * Pré-conditions :
 *   - graphe non NULL
 ...
 * Post-conditions :
 *   - retour >= 0.0
 *   - si chemin != NULL, *chemin contient un chemin connexe de source à
 *     destination La fonction se charge d'allouer le chemin sur le tas (et
 *     l'utilisateur se charge de le détruire).
 *
 ...
 * @param chemin [out] pointeur sur une variable de type liste_noeud_t* pour
