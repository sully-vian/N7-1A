...
-- Exemple d'utilisation des Unbounded_String
...
begin
    ...
    Put_Line
       ("La chaine est : " & Chaine);        -- ! & concaténation des chaînes

    -- Afficher la longueur d'une Unbounded_String
    Put ("Sa longueur est : ");
    Put (Length (Chaine), 1);
    New_Line;

    -- Afficher l'initiale de la chaîne
