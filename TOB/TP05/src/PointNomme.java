 ...
 * @version 1.7
 */
public class PointNomme extends Point { // on peut pas étendre (faire de subclass) de Point si final
	 ...
	 */
	@Override
	public void afficher() { // interdit si Point.afficher est final
