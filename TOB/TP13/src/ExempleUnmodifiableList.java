...
public class ExempleUnmodifiableList {
	...
	/*
	 * Le nom de cette méthode laisse penser qu'elle se contente de consulter la
	 * liste.
	...
	public static void exemple2() {
		...
		List<Integer> inmodifiable = Collections.unmodifiableList(mesNombres);

		for (int i : new int[] { 4, 0, 2, 7 }) {
			try {
				consulter(inmodifiable, i);
