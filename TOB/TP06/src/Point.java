...
public class Point extends ObjetGeometrique {
	...
	// private Color couleur; // couleur du point // On le tej parce qu'il
	// appartient à sa superclasse maintenant, ça override
	...
	public Point(double vx, double vy) {
		super(Color.green); // obligé d'invoquer un super constructeur
		this.x = vx;
		this.y = vy;
		// this.couleur = Color.green; // pas besoin pisk on a le constructeur qui le
		// fait
	}
	...
	// pas besoin si on l'a déjà dans la superclasse
