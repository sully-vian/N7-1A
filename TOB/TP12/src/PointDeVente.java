...
public class PointDeVente {
	...
	public int getPrix(Carburant carburant, LocalDateTime date) {
		NavigableMap<LocalDateTime, Integer> prixCarburant = prix.get(carburant);

		if (prixCarburant == null) {
			return 0;
		}

		LocalDateTime dateValide = prixCarburant.floorKey(date);

		if (dateValide == null) {
			return 0;
		}

		return prixCarburant.get(dateValide);
