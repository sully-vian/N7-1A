...
for i = 1:k
    ...
    % modifier D pour obtenir A tel K(A)=10^i
    D(1, 1) = 10 ^ i;
    A = U * D * U';
    ...
    % Perte d'othogonalité avec algo classique appliqué 2 fois
    Qcgs2 = cgs(Qcgs);
    po(3, i) = norm(eye(n) - Qcgs2' * Qcgs2);

    % perte d'othogonalité avec algo modifié appliqué 2 fois
    Qmgs2 = mgs(Qmgs);
