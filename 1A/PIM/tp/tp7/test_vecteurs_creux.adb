...
procedure Test_Vecteurs_Creux is
    ...
    begin
        ...
        pragma Assert (Est_Nul (VC0, Epsilon));
        pragma Assert (not Est_Nul (VC1, Epsilon));
        pragma Assert (not Est_Nul (VC2, Epsilon));
    ...
    type T_Fonction_Composante is
       access function
          (VC : in T_Vecteur_Creux; Indice : in Integer) return Float;
    ...
    begin
        ...
        pragma Assert (Est_Nul (VC1, Epsilon));
    ...
    generic
        with function Egaux
           (Vecteur1, Vecteur2 : in T_Vecteur_Creux; Epsilon : in Float)
            return Boolean;
    ...
    begin
        ...
        pragma Assert (Egaux (VC0, VC0, Epsilon));
        pragma Assert (Egaux (VC1, VC1, Epsilon));
        pragma Assert (Egaux (VC2, VC2, Epsilon));

        pragma Assert (not Egaux (VC0, VC1, Epsilon));
        pragma Assert (not Egaux (VC0, VC2, Epsilon));
        pragma Assert (not Egaux (VC1, VC2, Epsilon));

        pragma Assert (not Egaux (VC1, VC0, Epsilon));
        pragma Assert (not Egaux (VC2, VC0, Epsilon));
        pragma Assert (not Egaux (VC2, VC1, Epsilon));
        ...
        pragma Assert (Egaux (VC1, VC3, Epsilon));
        pragma Assert (Egaux (VC3, VC1, Epsilon));
    ...
    procedure Tester_Sont_Egaux_Iteratif is new Tester_Sont_Egaux
       (Sont_Egaux_Iteratif);

    procedure Tester_Sont_Egaux_Recursif is new Tester_Sont_Egaux
       (Sont_Egaux_Recursif);
    ...
    begin
        ...
        Additionner (VC0, VC1);
        pragma Assert (Sont_Egaux_Recursif (VC0, VC1, Epsilon));
        ...
        pragma Assert (Sont_Egaux_Recursif (VC0, VC2, Epsilon));
