...
procedure Tri_Selection is
    ...
    procedure Tri(Tab:  in out T_Tableau) is
        Ind_Min: Integer; -- indice du minimum
        Temp: Integer; -- variable temporaire pour faire l'échange
    begin
        for I in 1..Tab.Taille loop
            ...
            for J in I..Tab.Taille loop
                ...
                Temp := Tab.Elements(Ind_Min);
                Tab.Elements(Ind_Min) := Tab.Elements(I);
                Tab.Elements(I) := Temp;
        end loop;
    end Tri;
