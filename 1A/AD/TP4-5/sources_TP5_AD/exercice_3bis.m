...
load hyperparametre_exercice_3; 

% Calcul du SVM optimal
[X_VS,w,c,code_retour] = estim_param_SVM_marge(X_app,Y_app,lambda_opt_test); % FONCTION A CODER
...
Y_test_pred = classification_SVM(X_test,w,c); % FONCTION A CODER
...
Y_pred_grille = classification_SVM(X_grille,w,c); % FONCTION A CODER
