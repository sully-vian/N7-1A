...
[I_encodee,dictionnaire,hauteur,largeur] = encodage_image(I_decorrelee); % FONCTION A CODER

% Calcul de l'image recorrelee :
I_reconstruite = reconstruction_image(I_encodee,dictionnaire,hauteur,largeur); % FONCTION A CODER
