...
load hyperparametre_exercice_2;

% Calcul du SVM optimal
[X_VS, Y_VS, Alpha_VS, c] = estim_param_SVM_noyau(X_app, Y_app, sigma_opt_test); % FONCTION A CODER
...
figure('Name', 'Classification par SVM avec noyau gaussien (apprentissage)', ...
...
figure('Name', 'Classification par SVM avec noyau gaussien (test)', ...
