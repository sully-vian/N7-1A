...
x_donnees_bruitees = [x_donnees_bruitees; taille * (2 * rand(n_donnees_aberrantes, 1) - 1)];
y_donnees_bruitees = [y_donnees_bruitees; taille * (2 * rand(n_donnees_aberrantes, 1) - 1)];
